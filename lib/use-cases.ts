...
export const USE_CASES: UseCase[] = [
  ...
  },
  {
    ...
    category: "Executive Intelligence",
    description: "Every morning at 7:00 AM, cross-references email and calendar to surface process gaps, software needs, vendor decisions, and partnership opportunities — with numbered actions you can execute by replying.",
    howItWorks: [
      "Fetches last 48 hours of email via Microsoft Graph API",
      "Fetches next 14 days of calendar events",
      "Cross-references both — what's being discussed that has no supporting system?",
      "Surfaces 3-5 findings: signal, underlying problem, suggested action, priority",
      "Delivers to Telegram — reply with a number to act on any finding",
    ],
    ...
    livePreview: [
      ...
      { label: "Sources", value: "Email + Calendar" },
      { label: "Output", value: "3-5 findings" },
    ],
    icon: "🔍",
    tags: ["Email", "Calendar", "Microsoft Graph", "Intelligence"],
  },
  {
