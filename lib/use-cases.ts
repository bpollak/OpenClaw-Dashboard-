...
export const USE_CASES: UseCase[] = [
  ...
  },
  {
    ...
    category: "Competitive Intelligence",
    description: "Weekly scan of Reddit, campus forums, and social signals to surface technology friction points UC San Diego students are experiencing — a ground-truth feed for IT strategy.",
    howItWorks: [
  ...
  },
  {
    ...
    livePreview: [
      { label: "Nodes", value: "125+ entities" },
      { label: "Edges", value: "145+ relationships" },
